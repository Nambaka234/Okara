...
{
    public partial class AdminZakaz : Window
    {
        bool isAdmin = false;
        public AdminZakaz()
        {
        ...
        private async void DeleteZakazButton_Click(object? sender, RoutedEventArgs e)
        {
            int button = (int)(sender as Button).Tag;

            Helper.postgres.Orders.Remove(Helper.postgres.Orders.Find(button));
